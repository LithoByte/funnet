...
public protocol NetworkResponderProtocol {
    ...
    var downloadTaskHandler: (URLSessionDownloadTask?) -> Void { get set }
...
public struct NetworkResponder: NetworkResponderProtocol {
    ...
    public var downloadTaskHandler: (URLSessionDownloadTask?) -> Void = { _ in }
    ...
    public var urlHandler: (URL?) -> Void = { _ in }
